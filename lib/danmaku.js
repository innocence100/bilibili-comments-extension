...
$root.PrecompiledBilibiliDanmakuProto = (function() {

    /**
     * Namespace PrecompiledBilibiliDanmakuProto.
     * @exports PrecompiledBilibiliDanmakuProto
     * @namespace
     */
    var PrecompiledBilibiliDanmakuProto = {};

    PrecompiledBilibiliDanmakuProto.DanmakuElem = (function() {

        /**
         * Properties of a DanmakuElem.
         * @memberof PrecompiledBilibiliDanmakuProto
         ...
         * @constructor
         * @param {PrecompiledBilibiliDanmakuProto.IDanmakuElem=} [properties] Properties to set
         */
         ...
         * @memberof PrecompiledBilibiliDanmakuProto.DanmakuElem
         * @instance
         */
         ...
         * @static
         * @param {PrecompiledBilibiliDanmakuProto.IDanmakuElem=} [properties] Properties to set
         * @returns {PrecompiledBilibiliDanmakuProto.DanmakuElem} DanmakuElem instance
         */
        ...
        /**
         * Encodes the specified DanmakuElem message. Does not implicitly {@link PrecompiledBilibiliDanmakuProto.DanmakuElem.verify|verify} messages.
         * @function encode
         * @memberof PrecompiledBilibiliDanmakuProto.DanmakuElem
         * @static
         * @param {PrecompiledBilibiliDanmakuProto.IDanmakuElem} message DanmakuElem message or plain object to encode
        ...
        /**
         * Encodes the specified DanmakuElem message, length delimited. Does not implicitly {@link PrecompiledBilibiliDanmakuProto.DanmakuElem.verify|verify} messages.
         ...
         * @returns {PrecompiledBilibiliDanmakuProto.DanmakuElem} DanmakuElem
        ...
        DanmakuElem.decode = function decode(reader, length, error) {
            ...
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.PrecompiledBilibiliDanmakuProto.DanmakuElem();
        ...
        DanmakuElem.fromObject = function fromObject(object) {
            if (object instanceof $root.PrecompiledBilibiliDanmakuProto.DanmakuElem)
                return object;
            var message = new $root.PrecompiledBilibiliDanmakuProto.DanmakuElem();
            if (object.id != null)
                if ($util.Long)
         ...
         * @memberof PrecompiledBilibiliDanmakuProto.DanmakuElem
         * @static
         * @param {PrecompiledBilibiliDanmakuProto.DanmakuElem} message DanmakuElem
        ...
        DanmakuElem.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/PrecompiledBilibiliDanmakuProto.DanmakuElem";
        };

        return DanmakuElem;
    })();

    PrecompiledBilibiliDanmakuProto.DmSegMobileReply = (function() {

        /**
         * Properties of a DmSegMobileReply.
         * @memberof PrecompiledBilibiliDanmakuProto
         * @interface IDmSegMobileReply
         * @property {Array.<PrecompiledBilibiliDanmakuProto.IDanmakuElem>|null} [elems] DmSegMobileReply elems
         */
         ...
         * @constructor
         * @param {PrecompiledBilibiliDanmakuProto.IDmSegMobileReply=} [properties] Properties to set
         */
         ...
         * @member {Array.<PrecompiledBilibiliDanmakuProto.IDanmakuElem>} elems
         * @memberof PrecompiledBilibiliDanmakuProto.DmSegMobileReply
         * @instance
         */
         ...
         * @static
         * @param {PrecompiledBilibiliDanmakuProto.IDmSegMobileReply=} [properties] Properties to set
         * @returns {PrecompiledBilibiliDanmakuProto.DmSegMobileReply} DmSegMobileReply instance
         */
        ...
        /**
         * Encodes the specified DmSegMobileReply message. Does not implicitly {@link PrecompiledBilibiliDanmakuProto.DmSegMobileReply.verify|verify} messages.
         * @function encode
         * @memberof PrecompiledBilibiliDanmakuProto.DmSegMobileReply
         * @static
         * @param {PrecompiledBilibiliDanmakuProto.IDmSegMobileReply} message DmSegMobileReply message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        DmSegMobileReply.encode = function encode(message, writer) {
            ...
            if (message.elems != null && message.elems.length)
                for (var i = 0; i < message.elems.length; ++i)
                    $root.PrecompiledBilibiliDanmakuProto.DanmakuElem.encode(message.elems[i], writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
            return writer;
        };

        /**
         * Encodes the specified DmSegMobileReply message, length delimited. Does not implicitly {@link PrecompiledBilibiliDanmakuProto.DmSegMobileReply.verify|verify} messages.
         * @function encodeDelimited
         * @memberof PrecompiledBilibiliDanmakuProto.DmSegMobileReply
         * @static
         * @param {PrecompiledBilibiliDanmakuProto.IDmSegMobileReply} message DmSegMobileReply message or plain object to encode
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {PrecompiledBilibiliDanmakuProto.DmSegMobileReply} DmSegMobileReply
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        DmSegMobileReply.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.PrecompiledBilibiliDanmakuProto.DmSegMobileReply();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
                ...
                case 1: {
                        if (!(message.elems && message.elems.length))
                            message.elems = [];
                        message.elems.push($root.PrecompiledBilibiliDanmakuProto.DanmakuElem.decode(reader, reader.uint32()));
                        break;
                    }
                default:
                    reader.skipType(tag & 7);
        ...
        DmSegMobileReply.verify = function verify(message) {
            ...
            if (message.elems != null && message.hasOwnProperty("elems")) {
                ...
                for (var i = 0; i < message.elems.length; ++i) {
                    var error = $root.PrecompiledBilibiliDanmakuProto.DanmakuElem.verify(message.elems[i]);
                    if (error)
                        return "elems." + error;
                }
            }
        ...
        DmSegMobileReply.fromObject = function fromObject(object) {
            if (object instanceof $root.PrecompiledBilibiliDanmakuProto.DmSegMobileReply)
                return object;
            var message = new $root.PrecompiledBilibiliDanmakuProto.DmSegMobileReply();
            if (object.elems) {
                if (!Array.isArray(object.elems))
                    throw TypeError(".PrecompiledBilibiliDanmakuProto.DmSegMobileReply.elems: array expected");
                message.elems = [];
                for (var i = 0; i < object.elems.length; ++i) {
                    if (typeof object.elems[i] !== "object")
                        throw TypeError(".PrecompiledBilibiliDanmakuProto.DmSegMobileReply.elems: object expected");
                    message.elems[i] = $root.PrecompiledBilibiliDanmakuProto.DanmakuElem.fromObject(object.elems[i]);
                }
            }
            return message;
        };
         ...
         * @memberof PrecompiledBilibiliDanmakuProto.DmSegMobileReply
         * @static
         * @param {PrecompiledBilibiliDanmakuProto.DmSegMobileReply} message DmSegMobileReply
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        DmSegMobileReply.toObject = function toObject(message, options) {
            ...
            if (message.elems && message.elems.length) {
                ...
                for (var j = 0; j < message.elems.length; ++j)
                    object.elems[j] = $root.PrecompiledBilibiliDanmakuProto.DanmakuElem.toObject(message.elems[j], options);
            }
            return object;
        };
        ...
        DmSegMobileReply.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/PrecompiledBilibiliDanmakuProto.DmSegMobileReply";
        };

        return DmSegMobileReply;
    })();

    return PrecompiledBilibiliDanmakuProto;
})();